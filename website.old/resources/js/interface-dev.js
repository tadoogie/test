window.INTERFACE_DEV_BUILD = '2025-12-17-1';
...
function clearTextSelection() {
  ...
  if (container) {
    container.textContent = 'Select edition first';
  }
  ...
  if (metreContainer) {
    metreContainer.textContent = 'Select edition first';
  }
...
function updateSelectionSummary() {
  ...
  if (sourceVal) {
    ...
    srcOut.textContent = "Select Edition";
  }
...
function domContentLoadedHandler1980() {
  ...
  function populateSearchModalSourceList() {
    ...
    allButton.textContent = 'All editions';
