...
let page = 1;
let zoom = window.innerWidth <= 768 ? 40 : 50;
let trInterval = "0";
let timemap = [];
let timemapIdx = 0;
let lastOnsetIdx = 0;
...
function setOptions() {
    ...
    // ADD THIS:  Adjust zoom based on screen size if still at default
    if (window.innerWidth <= 768 && zoom === 50) {
        zoom = 40;
    } else if (window.innerWidth > 768 && zoom === 40) {
        zoom = 50;
    }
